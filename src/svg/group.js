...
const groupConfig = {
    group: ['edge', 'wave', 'curve', 'radius', 'vertex', 'link', 'center', 'excircle', 'axisX', 'axisY', 'grid', 'polar', 'fractal', 'animation', 'transform', 'pattern'],
    other: 'shape'
}
...
const optionsConfig = {
    ...
    fractalType: ['midSeg', 'zoom', 'scale', 'rotate', 'reproduce', 'tree', 'radiusRatio','vertexMirror'],
